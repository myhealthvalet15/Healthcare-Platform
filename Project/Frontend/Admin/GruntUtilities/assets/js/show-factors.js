document.addEventListener('DOMContentLoaded', function () {
  ...
  addFactorButton.addEventListener('click', () => {
    ...
    addFactorButton.innerHTML = `<span class="spinner-border spinner-border-sm" role="status" aria-hidden="true"></span>
         &nbspSaving...`;
  ...
  function addNewFactor(factorName, activeStatus) {
    if (!factorName || factorName.trim().length === 0) {
      ...
      errorMessage.innerHTML =
        '<div data-field="formValidationUsername" data-validator="notEmpty">The name is required</div>';
