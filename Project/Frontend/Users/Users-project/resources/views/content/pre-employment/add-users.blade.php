...
'resources/assets/vendor/libs/datatables-bs5/datatables-bootstrap5.js', 'resources/assets/vendor/libs/moment/moment.js',
            ...
            <form method="POST">
                ...
                <div class="row">
                    ...
                    <div class="mb-3 col-md-6">
                        ...
                        <input type="text" id="dob" name="dob" class="form-control flatpickr" placeholder="YYYY-MM-DD"
                            required>
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="mb-3 col-md-6">
                        ...
                        <input type="text" id="aadhar" name="aadhar" class="form-control" maxlength="12" required>
                    </div>
                </div>
