            ...
            <div class="tab-content p-0">
                ...
                <div class="tab-pane fade show active" id="payments" role="tabpanel">
                    ...
                    <div class="card mb-6">
                        ...
                        <div class="card-body">
                            <p class="mb-5">Providers that enable you to accept payment methods at a rate set by the
                                third-party.
                                An additional fee will apply to new orders once you select a plan</p>
                            <button class="btn btn-label-primary" data-bs-toggle="modal"
                                data-bs-target="#paymentProvider">Choose a provider</button>
                        </div>
                    ...
                    <div class="card mb-6">
                        <div class="card-header">
                            <div class="card-title m-0">
                                ...
                                <p class="my-0 card-subtitle">Payment methods that are available with one of myHealthvalet
                                    's
                                    approved payment providers.</p>
                            </div>
                        </div>
                        <div class="card-body">
                            ...
                            <button class="btn btn-label-primary" data-bs-toggle="modal"
                                data-bs-target="#paymentMethods">Add payment methods</button>
                        </div>
                    </div>
                    ...
                    <div class="card mb-6">
                        ...
                        <div class="card-body">
                            <p class="mb-5">Payments that are made outside your online store. When a customer selects a
                                manual payment method such as cash on delivery. You'll need to approve their order before it
                                can be fulfilled.</p>
                            <div class="btn-group">
                                ...
                                <ul class="dropdown-menu">
                                    <li><a class="dropdown-item" href="javascript:void(0);">Create custom payment method</a>
                                    </li>
