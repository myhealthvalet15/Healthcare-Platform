...
'resources/assets/vendor/libs/moment/moment.js', 'resources/assets/vendor/libs/sweetalert2/sweetalert2.js',
'resources/assets/vendor/libs/select2/select2.js', 'resources/assets/vendor/libs/flatpickr/flatpickr.js',
...
@endsection
<link rel="stylesheet" href="/lib/css/page-styles/hospitalization-details.css">
@section('content')
@php
                ...
                <div class="medical-info-row">
                    ...
                    <div class="medical-info-column">
                        ...
                        <p class="info-content">
                            ...
                            ', ',
                            array_map(
                            fn($s) => ucwords(str_replace(['shopFloor', 'nonShopFloor'], ['Shop Floor', 'Non Shop
                            Floor'], $s)),
