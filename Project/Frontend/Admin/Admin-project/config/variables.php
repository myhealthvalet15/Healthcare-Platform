...
return [
  ...
  "livePreview" => "https://demos.pixinvent.com/myHealthvalet  -html-admin-template/landing/",
  "productPage" => "https://1.envato.market/myHealthvalet_admin",
  "support" => "https://pixinvent.ticksy.com/",
  "moreThemes" => "https://1.envato.market/pixinvent_portfolio",
  "documentation" => "https://demos.pixinvent.com/myHealthvalet  -html-admin-template/documentation",
  "generator" => "",
  "changelog" => "https://demos.pixinvent.com/myHealthvalet  /changelog.html",
  "repository" => "https://github.com/pixinvent/myHealthvalet  -html-admin-template",
  "gitRepo" => "pixinvent",
  "gitRepoAccess" => "myHealthvalet  -html-admin-template",
