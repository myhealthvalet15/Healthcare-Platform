...
@section('content')
                    ...
                    <div id="po_invoice_form" class="content">
                        ...
                        <div class="row g-6">
                            ...
                            <div class="col-sm-6">
                                ...
                                <input type="text" id="invoice_date"
                                    class="form-control dob-picker flatpickr-input active" placeholder="DD-MM-YYYY"
                                    readonly="readonly" fdprocessedid="4n8qxi">
                            </div>
                            <div class="col-sm-6">
                        ...
                        <div class="row g-6">
                            ...
                            <div class="col-sm-6">
                                ...
                                <input type="date" id="head_verify_date" name="head_verify_date"
                                    class="form-control">
                            </div>
                            <div class="col-sm-6">
    ...
    <script src="/lib/js/page-scripts/add-invoice.js"></script>
