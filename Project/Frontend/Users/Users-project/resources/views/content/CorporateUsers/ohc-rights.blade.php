            ...
            <form id="wizard-validation-form" method="post">
                ...
                <div id="account-details-validation" class="content" style="display:block;">
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="hidden" name="corporate_ohc_rights_id" id="corporate_ohc_rights_id" class="form-check-input" type="text" value="">
                    ...
                    <div class="col-md-8"> 
                     <label>Health Index Dashboard</label>
                      ...
                      <div class="col-sm-6">
                                <button type="button" class="btn btn-primary" id="save_ohc_rights">Save </button>
...
<script>
    ...
    $(document).ready(function () {
        ...
        $.ajax({
            url: "{{ route('get-ohc-menu',['id' => $corporateuser['id']]) }}", // The route you defined
            method: 'GET',
...
$.each(formData, function() {
    formDataObject[this.name] = this.value;
      ...
      // console.log(formData);
            ...
            $.ajax({
                url: "{{ route('saveohcRights') }}", // Adjust the route if needed
                method: 'POST',
                data: formData,
                success: function (response) {
...
$.each(formData, function() {
   formDataObject[this.name] = this.value;
     ...
     // console.log(formData);
           // AJAX request to save the data
           $.ajax({
               url: "{{ route('updateohcRights') }}", // Adjust the route if needed
               method: 'POST',
               data: formData,
               success: function (response) {
                   console.log("response:", response.result);
