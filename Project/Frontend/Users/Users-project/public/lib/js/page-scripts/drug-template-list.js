...
document.addEventListener('DOMContentLoaded', function (e) {
    ...
    $(function () {
        ...
        if (dt_basic_table.length) {
            var dt_basic = dt_basic_table.DataTable({
                ...
                columns: [
                    ...
                    },
                    {
                        ...
                        render: function (data, type, row) {
                            ...
                            return ingredientNames.filter(Boolean).join(', ') || 'Unknown Ingredient';
                        }
                    },
                    {
                        ...
                        render: function (data, type, row) {
                            return `
                                ...
                                <button class="btn btn-outline-primary btn-sm showDetailsBtn" 
                                        data-drug_template_id="${row.drug_template_id}" 
                                        style="border:none;">
                                    <i class="fa fa-eye"></i>
                                </button>
                            `;
                ...
                initComplete: function () {
                    ...
                    $('.datatables-basic tbody').on('click', '.showDetailsBtn', function () {
                        ...
                        $('#modalNdrug_type').text(drugTypes[rowData.drug_type] || 'Unknown');
            ...
            // Enhance filter input
            $('#DataTables_Table_0_filter label').contents().filter(function () {
                return this.nodeType === 3;
            }).remove();
            $('#DataTables_Table_0_filter input')
                .attr('placeholder', 'Search By:Drug Name Or Type Or Manufacturer')
                .css({
                    width: '370px',
                    height: '37px',
                    'font-size': '15px'
