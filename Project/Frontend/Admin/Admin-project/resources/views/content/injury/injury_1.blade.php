...
<div class="container" style="display: flex; flex-direction: column; gap: 30px; align-items: center;">
    <div class="col-12 mb-4 text-end">
        <button id="showFormBtn" class="btn btn-primary px-4 py-2 btn-shadow frombtnn">
            <i class="fas fa-plus-circle me-2"></i> Add New Injury
        </button>
    </div>
        ...
        <form id="injuryForm">
            <div style="display: flex; gap: 10px; align-items: center;">
                <input type="text" class="typ form-control" name="name" placeholder="Enter Injury Name"
                    style="flex: 1; padding: 10px 15px; border: 1px solid #ddd; border-radius: 8px; font-size: 14px;">
                <input type="hidden" class="cat" name="cat" value="1">
                <input type="hidden" class="active_status_id" name="active_status_id" value="1">
                <button type="button" class="btnsysadd btn-gradient"
                    style="padding: 10px 20px; color: white; background: #007BFF; border: none; border-radius: 8px; font-size: 14px; cursor: pointer;">
                    Add
                </button>
            </div>
        </form>
...
<script src="/lib/js/page-scripts/injury_1.js"></script>