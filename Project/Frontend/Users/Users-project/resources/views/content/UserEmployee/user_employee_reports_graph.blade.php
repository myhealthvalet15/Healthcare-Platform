...
<div style="display: flex; flex-direction: column; gap: 30px;">
  ...
  <!-- Chart container: Glucose & HbA1C side by side -->
  ...
  <!-- Row 1: Glucose and HbA1C result tables side by side -->
  ...
  <!-- Row 2: Reference range tables side by side -->
...
function updateChartWithData(data, canvasId, tableContainerId) {
  ...
  // =========================
  // ✅ Add Legend (if not already shown)
  // =========================
...
function renderGlucoseTable(data, container) {
  ...
  // Fix here: use html instead of glucoseTables
...
function renderHbA1CTable(data, container) {
  // Build your HTML string for HbA1C results table
  let hba1cTables = `
    <table class="table table-bordered">
      <thead>
        <tr>
