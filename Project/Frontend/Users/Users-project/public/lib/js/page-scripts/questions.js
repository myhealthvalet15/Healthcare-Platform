$(document).ready(function () {
            ...
            columnDefs: [
                ...
                },
                {
                    ...
                    render: function (data) {
                        ...
                        } else if (data === "third_gender") {
                            genderClass = "bg-label-warning";
                        } else {
                            genderClass = "bg-label-secondary";
                        }
                        return `<span class="badge ${genderClass}">${genderText}</span>`;
                    },
                },
                {
                    targets: -1,
    ...
    $(document).on("click", ".edit-question", function () {
        ...
        if (!questionId) {
            // console.error("Question ID not found on the button element.");
            return;
        }
        ...
        document.querySelector(
            `input[name="hra_gender"][value="${questionData.gender}"]`
        ).checked = true;
        ...
        if (!testSelect) {
            // console.error("Test select element not found");
            return;
        }
        ...
        try {
            ...
            // console.error("Error handling test selection:", error, error.stack);
        }
    ...
    $(document).on("click", "#save-modifications", function (event) {
        ...
        formData.append(
            "gender",
            $('input[name="hra_gender"]:checked').val() || ""
        );
