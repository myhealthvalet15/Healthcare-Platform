...
@section('content')
            ...
            <div class="bs-stepper-content">
                <div style="display: flex; justify-content: flex-end; margin-bottom: 10px;">
                    <button type="button" class="btn btn-primary" id="back-to-list"
                        onclick="window.location.href='/prescription/prescription-template'" style="margin-right: 20px;">Back
                        to List</button>
                </div>
                <!-- Form for Template Name -->
                <div class="template-name-field" style="padding: 10px 0;">
                    <label for="template-name">Template Name:</label>
                    <input type="text" id="template-name" name="template-name" class="form-control" readonly
                        placeholder="Enter Template Name" style="width: 100%; max-width: 308px;">
                </div>

                <!-- Prescription Input Section using div layout -->
                <div class="prescription-inputs"
                    style="display: flex; flex-direction: column; gap: 15px; padding: 5px 0; border-bottom: 1px #333 solid; font-weight: bold;">
                    ...
                    <div class="prescription-row" style="display: flex; align-items: center; gap: 10px;">
                        ...
                        <div style="width: 35%;">
                            ...
                            <div class="drugname" title="drugname">
                                ...
                                <select class="hiddendrugname select2" name="hiddendrugname[]" id="drug_template_0"
                        ...
                        <div style="width: 30%;margin-left:20px;">
                            <div style="float:left;width: 60px;">
                                <input type="text" maxlength="2" name="morning[]" class="morning input-minix"
                                    placeholder="0" onkeypress="return ValidNumber(event)"
                                    style="width:50px; text-align:center;margin-right: 8px;height:35px;">
                            </div>
                            <div style="float:left;width: 60px;">
                                <input type="text" maxlength="2" name="afternoon[]" class="afternoon input-minix"
                                    placeholder="0" onkeypress="return ValidNumber(event)"
                                    style="width:50px; text-align:center;margin-right: 8px;height:35px;">
                            </div>
                            <div style="float:left;width: 60px;">
                                <input type="text" maxlength="2" name="evening[]" class="evening input-minix"
                                    placeholder="0" onkeypress="return ValidNumber(event)"
                                    style="width:50px; text-align:center;margin-right: 8px;height:35px;">
                            </div>
                            <div style="float:left;width: 60px;">
                                <input type="text" maxlength="2" name="night[]" class="night input-minix"
                                    placeholder="0" onkeypress="return ValidNumber(event)"
                                    style="width:50px; text-align:center;margin-right: 8px;height:35px;">
                            </div>
                        </div>
    ...
    <script src="/lib/js/page-scripts/prescription-edit.js"></script>
