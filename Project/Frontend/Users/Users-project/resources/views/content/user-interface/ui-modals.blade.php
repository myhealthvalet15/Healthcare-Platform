                ...
                <div class="carousel-inner">
                  ...
                  <div class="carousel-item">
                    <div class="onboarding-media">
                      <div class="mx-2">
                        <img
                          src="{{asset('assets/img/illustrations/girl-verify-password-'.$configData['style'].'.png')}}"
          ...
          <div class="modal-dialog modal-xl" role="document">
            <div class="modal-content text-center">
              ...
              <div id="modalHorizontalCarouselControls" class="carousel slide pb-6 mb-2" data-bs-interval="false">
                <div class="carousel-indicators">
                  <button type="button" data-bs-target="#modalHorizontalCarouselControls" data-bs-slide-to="0"
